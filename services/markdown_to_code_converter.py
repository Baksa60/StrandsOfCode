...
class MarkdownToCodeConverter(BaseReverseConverter):
    """
    Конвертирует Markdown файлы обратно в исходные файлы кода
    """
    ...
    def convert_to_code(self, text_content: str, output_folder: Path, 
        ...
        """
        Конвертирует Markdown обратно в код
        """
        ...
        if file_structure:
            ...
            output_files = self._restore_markdown_structure(
    ...
    def _restore_markdown_structure(self, file_structure: Dict[str, str], 
                                 output_folder: Path, default_language: str) -> List[Path]:
        """
        Восстанавливает структуру файлов из Markdown
        """
        output_files = []
        ...
        for line in lines:
            ...
            # Собираем контент файла
                ...
                if '```' in line:
                    ...
                    if in_code_block:  # Начало блока кода
                        current_content.append(line)
                    else:  # Конец блока кода
                        pass  # Пропускаем строку с ```
